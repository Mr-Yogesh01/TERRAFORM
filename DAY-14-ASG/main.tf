...
resource "aws_security_group" "ec2_sg" {
  ...
  ingress {
    ...
    to_port         = 80
    protocol        = "tcp"
    security_groups = [aws_security_group.alb_sg.id] # ALB can talk to EC2
  }
...
resource "aws_security_group" "db_sg" {
  ...
  ingress {
    ...
    to_port         = 3306
    protocol        = "tcp"
    security_groups = [aws_security_group.ec2_sg.id] # only EC2 can reach RDS
  }
